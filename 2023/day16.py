...
def main():
    ...
    def count_energized(starting_point, starting_direction):
        ...
        visit_next(starting_point, starting_direction)
    ...
    print(f"Part 1: {count_energized(Point(0, 0), E)}")

    part2 = 0
    for y in range(0, max_y + 1):
        part2 = max(part2, count_energized(Point(0, y), E))
        part2 = max(part2, count_energized(Point(max_x, y), W))
    for x in range(0, max_x + 1):
        part2 = max(part2, count_energized(Point(x, 0), S))
        part2 = max(part2, count_energized(Point(x, max_y), N))
